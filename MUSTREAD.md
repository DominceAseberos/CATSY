...
![alt text](steps-imgs/image.png)


2. Create new branch for that issue to work
![alt text](steps-imgs/image-1.png)
...
FOLLOW THIS STEPS:
![alt text](steps-imgs/image-4.png)
![alt text](steps-imgs/image-5.png)
![alt text](steps-imgs/image-6.png)
...
![alt text](steps-imgs/image-3.png)

6. Go back to Repository and Request PR (pull request)
![alt text](steps-imgs/image-7.png)
![alt text](steps-imgs/image-8.png)


7. WAIT for review and accepted
![alt text](steps-imgs/image-9.png)
