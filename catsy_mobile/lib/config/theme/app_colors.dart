...
class AppColors {
  ...
  // ── Dashboard Pastel Theme ────────────────────────────────────────────
  static const Color dashboardBg = Color(0xFFFFF5F5); // Soft pink background
  static const Color dashboardCard = Color(0xFFFFFFFF); // White cards
  static const Color dashboardPink = Color(0xFFFF6B8A); // Pink accent
  static const Color dashboardPurple = Color(0xFF9B8FFF); // Purple accent
  static const Color dashboardGreen = Color(0xFF4CAF50); // Green
  static const Color dashboardRed = Color(0xFFE53935); // Red (occupied table)
  static const Color dashboardReserved = Color(
    0xFFFF4081,
  ); // Pink-red for reserved table
  static const Color dashboardGrey = Color(
    0xFFF5F5F5,
  ); // Light grey for available table bg
