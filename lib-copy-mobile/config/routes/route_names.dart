/// Centralised route name constants – prevents typos when navigating.
class RouteNames {
  RouteNames._();
  ...
  static const String orderBuilder = 'order-builder';
  ...
  static const String stampResult = 'stamp-result';
